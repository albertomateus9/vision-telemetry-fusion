    ...
    <main>
      <section className="hero">
        ...
        <div className="statusPanel">
          <span>MVP local</span>
          <strong>{({ fresnel: 'Fresnel', ocr: 'OCR local', color: 'Cores de cabos', gesture: 'Gestos', occupancy: 'Ocupacao anonima', depth: 'Profundidade', benchmark: 'Benchmark', telemetry: 'Telemetria', subnet: 'Sub-redes', packet: 'Pacotes', etl: 'ETL', serial: 'Serial Web', helpdesk: 'Help desk', inventory: 'Inventario', schedule: 'Agenda', cyber: 'Ciberseguranca' } as Record<string, string>)[project.type] || project.type}</strong>
  ...
  return (
    <Shell>
      <div className="grid">
        ...
        <section className="panel">
          <label>Contagem anonima {people}<input type="range" min="0" max="40" value={people} onChange={(e) => setPeople(Number(e.target.value))} /></label>
    ...
    <Shell>
      <div className="grid">
        ...
        <section className="panel">
          ...
          <label>Contraste de profundidade {scan}<input type="range" min="20" max="100" value={scan} onChange={(e) => setScan(Number(e.target.value))} /></label>
...
function EdgeCvBenchmark() {
  const [frames, setQuadros] = useState(180);
  ...
  return (
    <Shell>
      <div className="grid">
        ...
        <section className="panel">
          <label>Quadros {frames}<input type="range" min="60" max="420" value={frames} onChange={(e) => setQuadros(Number(e.target.value))} /></label>
...
function App() {
  switch (project.type) {
    ...
    default: return <Shell><section className="panel">Tipo de projeto desconhecido.</section></Shell>;
  }
}
